...
namespace FirstWeb.Controllers
{
    public class AnimalController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Address,Eat")] Animal animal)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Name,Address,Eat")] Animal animal)
        {
            if (id != animal.Name)
            {
                return NotFound();
        ...
        {
          return (_context.Animal?.Any(e => e.Name == id)).GetValueOrDefault();
        }
    }
}
