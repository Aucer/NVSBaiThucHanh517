...
namespace FirstWeb.Controllers
{
    public class DogController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CatID,CatAge,AnimalsName,Address,Age")] Dog dog)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("CatID,CatAge,AnimalsName,Address,Age")] Dog dog)
        {
            if (id != dog.AnimalsName)
            {
                return NotFound();
            }
        ...
        {
          return (_context.Dog?.Any(e => e.AnimalsName == id)).GetValueOrDefault();
        }
    }
}
