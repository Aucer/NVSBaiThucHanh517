...
namespace FirstWeb.Controllers
{
    public class DogController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Chungloai,Name,Address,Eat")] Dog dog)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Chungloai,Name,Address,Eat")] Dog dog)
        {
            if (id != dog.Name)
            {
                return NotFound();
        ...
        {
          return (_context.Dog?.Any(e => e.Name == id)).GetValueOrDefault();
        }
    }
}
