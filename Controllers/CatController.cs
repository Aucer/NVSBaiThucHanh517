...
namespace FirstWeb.Controllers
{
    public class CatController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Sothich,Name,Address,Eat")] Cat cat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Sothich,Name,Address,Eat")] Cat cat)
        {
            if (id != cat.Name)
            {
                return NotFound();
        ...
        {
          return (_context.Cat?.Any(e => e.Name == id)).GetValueOrDefault();
        }
    }
}
