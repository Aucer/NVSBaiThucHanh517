...
namespace FirstWeb.Controllers
{
    public class CatController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CatID,CatCategory,AnimalsName,Address,Age")] Cat cat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("CatID,CatCategory,AnimalsName,Address,Age")] Cat cat)
        {
            if (id != cat.AnimalsName)
            {
                return NotFound();
            }
        ...
        {
          return (_context.Cat?.Any(e => e.AnimalsName == id)).GetValueOrDefault();
        }
    }
}
