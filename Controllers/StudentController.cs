...
namespace FirstWeb.Controllers
{
    public class StudentController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StudentID,MVS,Age,FacultyID")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("StudentID,MVS,Age,FacultyID")] Student student)
        {
